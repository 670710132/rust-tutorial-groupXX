...
| สมาชิก | รายละเอียดความรับผิดชอบ |
| :--- | :--- |
| **Member 1** <br> (นางสาวธนัญญา พรมภักดี) | • อธิบายทฤษฎีพื้นฐานของ Conditional Structures (if, else if, else, match) <br> • ยกตัวอย่างโค้ดสั้นๆ ประกอบการอธิบาย |
| **Member 2** <br> (นายธีทัต สุจริตพาณิช) | • เขียนและลงรายละเอียดโค้ดตัวอย่างแบบลึก <br> • รับผิดชอบการทำ Live Demo รันโปรแกรมให้ดู |
| **Member 3** <br> (นายทิบดี ช้างทอง) | • เปรียบเทียบไวยากรณ์และการทำงานของ Rust กับภาษาอื่น (C/Python) <br> • วิเคราะห์ตามหลักการ PPL |
| **Member 4** <br> (นายนนธวัช งามบุญศิริสิงห์) | • ออกแบบและเฉลยแบบฝึกหัด (Exercises) <br> • รวบรวมข้อผิดพลาดที่พบบ่อย (Common Mistakes) และโจทย์ท้าทาย (Challenge) |
