...
กลุ่มเราใช้วิธีแบ่งหัวข้อการทำงานอย่างชัดเจนตามความถนัดของสมาชิกแต่ละคน[cite: 3] โดยใช้ GitHub Repository เป็นพื้นที่กลางในการรวบรวมไฟล์เอกสารและไฟล์โค้ด[cite: 1, 3] สมาชิกทุกคนมีการอัปเดตไฟล์เนื้อหาผ่านการ Commit[cite: 3] รวมถึงมีการพูดคุยสื่อสารข้ามช่องทางออนไลน์เพื่อตรวจสอบความถูกต้องของเนื้อหาให้สอดคล้องกันก่อนบันทึกงานครับ[cite: 3]

#### Problems encountered
1. **การจัดโครงสร้างไฟล์บน GitHub:** สมาชิกในกลุ่มช่วงแรกยังไม่ชินกับการสร้างโฟลเดอร์สำหรับเก็บไฟล์โค้ด `.rs` และโครงสร้างโปรเจกต์[cite: 3]
2. **การตั้งค่าสภาพแวดล้อมการทำงาน:** พบปัญหาการตั้งค่าและลง Extension ของเครื่องมือพัฒนาโปรแกรมก่อนการสั่งรันโค้ดจริง[cite: 3]

#### How did you solve them?
1. ร่วมกันออกแบบโครงสร้างโฟลเดอร์กลาง `code_examples/` ให้ชัดเจน[cite: 1] และแนะนำขั้นตอนการกดสร้างไฟล์พร้อมโฟลเดอร์ผ่านหน้าเว็บ GitHub ให้สมาชิกในกลุ่มทำตามได้ง่ายขึ้น[cite: 3]
2. ช่วยกันสืบค้นวิธีแก้ไขข้อผิดพลาดใน Terminal จนสามารถสั่งรันและ Compile โค้ดผ่านคำสั่ง `cargo run` ได้อย่างถูกต้องครบถ้วนก่อนส่งงานครับ[cite: 3]
---
